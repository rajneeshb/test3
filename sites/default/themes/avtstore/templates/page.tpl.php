...
<body class="<?php print $classes . " nid-" . @$node->nid; ?>">
  ...
  <?php print $closure; ?>
<?php
  if(arg(0) == 'confirm' && arg(1) == 'thanks' && ( arg(2) == 'private' || arg(2) == 'court' ) ) {
    echo '<img src="http://ad.retargeter.com/seg?add=391419&t=2" width="1" height="1" />';
  }
  else {
    echo '<img src="http://ad.retargeter.com/seg?add=391418&t=2" width="1" height="1" />';
  }
?>
</body>
</html>
